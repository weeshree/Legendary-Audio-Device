...
VisualizerL::VisualizerL(TFT_eSPI thatTft)
{
...
void VisualizerL::updatePosArray()
{
...
void VisualizerL::softMaxer(double *arr, int len)
{
  double sum = 0.0;
...
int VisualizerL::getColorFromPos(double pos)
{
...
String VisualizerL::getNote(double peak)
{
  int octave = 1;
  while(peak >= 55)
  {
...
void VisualizerL::drawNote(boolean loud, double peak)
{
  if(loud)
  {
